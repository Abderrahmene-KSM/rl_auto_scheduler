...
class CompilingService:
    ...
    def get_schedule_code(
        ...
        comps = comps_trans.keys()
        for comp in comps:
            if comps_trans[comp]["transformed"]:
                transformation_str = ".matrix_transform("+ numpy_array_to_string(comps_trans[comp]["matrix"]) +");"
